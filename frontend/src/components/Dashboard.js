                ...
                <div className="mobile-content">
                    ...
                    {selectedFolder ? (
                        <div className="mobile-image-view">
                            <ViewImages folder={selectedFolder} onFolderUpdate={(updatedFolder) => {
                ...
                <div className="dialog-overlay">
                    <div className="dialog-box">
                        ...
                        <div className="dialog-actions">
                            ...
                            <button onClick={() => setShowAddFolderDialog(false)}>Cancel</button>
                        </div>
                    </div>
                </div>
            )}
                ...
                <div className="dialog-overlay">
                    <div className="dialog-box">
                        ...
                        <div className="dialog-actions">
                            ...
                            <button onClick={() => setShowToggleAccessDialog(false)}>Cancel</button>
                        </div>
                    </div>
                </div>
            )}
